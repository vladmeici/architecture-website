 ...
 */ !function(t) {
    ...
    t.cleanData = function(e) {
        ...
        t.fn[e] = function(o) {
            ...
            return o = !r && a.length ? t.widget.extend.apply(null, [
                o
            ].concat(a)) : o, r ? this.each(function() {
        ...
        _trigger: function(e, s, i) {
            ...
            return this.element.trigger(s, i), !(t.isFunction(r) && r.apply(this.element[0], [
                s
            ].concat(i)) === !1 || s.isDefaultPrevented());
        }
    }, t.each({
        show: "fadeIn",
        hide: "fadeOut"
    ...
    t.widget("aerolab.midnight", {
        ...
        _getSupportedTransform: function() {
            for(var t = [
                ...
                "OTransform",
                "msTransform"
            ], e = 0; e < t.length; e++)if (void 0 !== document.createElement("div").style[t[e]]) return t[e];
            return !1;
        },
        ...
        _setupHeaders: function() {
            ...
            this.element.css("padding-top"), this.element.css("padding-right"), this.element.css("padding-bottom"), this.element.css("padding-left");
            this.element.css({
                position: "fixed",
                top: 0,
                left: 0,
            ...
            var o = this.element.find("> ." + this.options.headerClass), r = o.filter("." + this.options.defaultClass).clone(!0, !0);
        ...
        _updateHeaders: function() {
            if ("undefined" != typeof this._headers[this.options.defaultClass]) {
                var t = 0, e = "";
                for(var s in this._headers)this._headers.hasOwnProperty(s) && (this._headers[s].from, true) && (t += this._headers[s].progress, e = s);
                ...
                for(var i in this._headers)if (this._headers.hasOwnProperty(i) && (this._headers[i].from, true)) {
...
//# sourceMappingURL=index.8791f8c4.js.map
