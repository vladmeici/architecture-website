...
window.onload = function() {
    ...
    headings.forEach((heading, i)=>{
        ...
        if (i === headings.length - 1) tl.to(heading, {
            opacity: 1
        }).to(heading, {
            opacity: 1
        });
    ...
    var pulse1 = document.getElementsByClassName("pulse1"), plusButton1 = document.getElementsByClassName("plus-button-1"), popout1 = document.getElementsByClassName("popout-1"), popout1Visible = false, pulse1Timeline = new TimelineMax({
        repeat: -1,
        repeatDelay: 0.5
    }), pulse2 = document.getElementsByClassName("pulse2"), plusButton2 = document.getElementsByClassName("plus-button-2"), popout2 = document.getElementsByClassName("popout-2"), popout2Visible = false, pulse2Timeline = new TimelineMax({
        repeat: -1,
        repeatDelay: 0.5
    }), pulse3 = document.getElementsByClassName("pulse3"), plusButton3 = document.getElementsByClassName("plus-button-3"), popout3 = document.getElementsByClassName("popout-3"), popout3Visible = false, pulse3Timeline = new TimelineMax({
        repeat: -1,
        repeatDelay: 0.5
    });
    if (window.innerWidth < 992) pulse1 = document.getElementsByClassName("pulse1-mobile"), plusButton1 = document.getElementsByClassName("plus-button-1-mobile"), popout1 = document.getElementsByClassName("popout-1-mobile"), popout1Visible = false, pulse1Timeline = new TimelineMax({
        repeat: -1,
        repeatDelay: 0.5
    }), pulse2 = document.getElementsByClassName("pulse2-mobile"), plusButton2 = document.getElementsByClassName("plus-button-2-mobile"), popout2 = document.getElementsByClassName("popout-2-mobile"), popout2Visible = false, pulse2Timeline = new TimelineMax({
        repeat: -1,
        repeatDelay: 0.5
    }), pulse3 = document.getElementsByClassName("pulse3-mobile"), plusButton3 = document.getElementsByClassName("plus-button-3-mobile"), popout3 = document.getElementsByClassName("popout-3-mobile"), popout3Visible = false, pulse3Timeline = new TimelineMax({
        repeat: -1,
        repeatDelay: 0.5
    });
    ...
    window.onclick = function(e) {
        if (e.target !== plusButton1[0] && !plusButton1[0].contains(e.target) && e.target !== popout1[0] && !popout1[0].contains(e.target) && e.target !== plusButton2[0] && !plusButton2[0].contains(e.target) && e.target !== popout2[0] && !popout2[0].contains(e.target) && e.target !== plusButton3[0] && !plusButton3[0].contains(e.target) && e.target !== popout3[0] && !popout3[0].contains(e.target)) {
            if (popout1Visible) {
                gsap.fromTo(popout1[0], {
                    opacity: 1
                }, {
...
},{"./timeline.js":"wIICh"}],"wIICh":[function(require,module,exports) {
...
},{}]},["5anPP","3cYfC"], "3cYfC", "parcelRequire4db0")
